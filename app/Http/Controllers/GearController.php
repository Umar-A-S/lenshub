...
/* Catatan:
    ...
    2.  Store: 
        Untuk add gear baru ke database. Fungsi ini secara otomatis membuatkan kode unik (seperti CAM_001) dan mengelola unggahan foto;
    3.  updateStatus: 
        Fitur untuk mengubah status operasional barang (contoh: dari Available ke Maintenance). Di View, kamu cukup membuat tombol yang mengarah ke URL route dengan menyertakan parameter status yang diinginkan.
    4.  updateCondition: 
        Memperbarui kondisi fisik barang (seperti 'baik' atau 'rusak') sekaligus mencatat riwayat perubahannya ke tabel GearConditionLog.
    5.  duplicate: 
...
class GearController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $validated = $request->validate([
            ...
            'unit_code'   => 'nullable|string|unique:gears,unit_code',
